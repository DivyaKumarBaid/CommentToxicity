        ...
        <div className="w-[100%] min-h-[100vh] flex flex-col items-center p-2 md:p-8 gap-4">
          <div className="w-[100%] shadow-[0px_0px_8px_var(--shadow)] rounded-lg flex gap-8 justify-between p-4 md:px-8 items-center">
            ...
            <div className='items-center gap-8 hidden md:flex'>
              ...
              <a href="https://github.com/DivyaKumarBaid/CommentToxicity"><div className="flex items-center justify-center rounded-[50%] bg-[var(--light-base-theme)] w-[45px] h-[45px] shadow-md"><BsGithub className='text-2xl' /></div></a>
            </div>
          </div>
